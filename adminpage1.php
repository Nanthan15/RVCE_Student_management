...
if (!isset($_SESSION['user'])) {
    ...
    $q = "select * from student where USN='$sn'";
    ...
    while ($d = mysqli_fetch_assoc($r)){
      ...
      <input type='text' class='form-control' id='inputl4' name= 'Name' value='".$d['Name']."' disabled>
      <input type='hidden' class='form-control' id='inputl4' name= 'Name' value='".$d['Name']."' >
    </div>

    <div class='col-10'>
              <label for='input15' class='form-label'>USN : </label>
              <input type='text' class='form-control' id='input15' name = 'USN' value='".$d['USN']."' disabled>
              <input type='hidden' class='form-control' id='input15' name = 'USN' value='".$d['USN']."' >
            </div>
            <div class='col-10'>
              <label for='input16' class='form-label'>BRANCH : </label>
              <input type='text' class='form-control' id='input16' placeholder='' name='Branch' value='".$d['Branch']."' disabled>
              <input type='hidden' class='form-control' id='input16' placeholder='' name='Branch' value='".$d['Branch']."' >
            </div>
            <div class='col-10'>
              <label for='input17' class='form-label'>SECTION : </label>
              <input type='text' class='form-control' id='input17' placeholder='' name = 'Section'value='".$d['Section']."' disabled>
              <input type='hidden' class='form-control' id='input17' placeholder='' name = 'Section'value='".$d['Section']."' >
            </div>
            <div class='col-10'>
              <label for='input18' class='form-label'>EMAIL : </label>
              <input type='email' class='form-control' id='input18' name='email' value='".$d['email']."' disabled>
              <input type='hidden' class='form-control' id='input18' name='email' value='".$d['email']."' >
            </div>
